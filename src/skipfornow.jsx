...
const Skip = () => {
  return ( 
    <div className='flex flex-col justify-center items-center gap-y-4 mt-4'>
      <img src={ One } className='w-3/5 lg:border-1 border-blue-600'/>
      <img src={ two } className='w-3/5 lg:border-1 border-blue-600''/>
      <img src={ three } className='w-3/5'/>
      <img src={ four } className='w-3/5'/>
      <img src={ five } className='w-3/5'/>
    </div>
  );
}
